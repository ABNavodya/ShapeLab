...
public class NonagonTransferable implements Transferable {
    ...
    //create a parameterized constructor called NonagonTransferable by accessing the current context

    public NonagonTransferable(Shape shape){
        this.shape = shape;
    }
