...
public class CubeThreeD implements GLEventListener{
    ...
    public void reshape(GLAutoDrawable drawable, int x, int y, int width, int height){
        ...
        //sets the view port of the whole window -> viewport is the area that the cube is drawn
    ...
    public static void main(String[] args){
        ...
        //create a button to the Square Screen
        JButton squareButton = new JButton("Back");
        squareButton.setBackground(new Color(48,57,82));
        squareButton.setForeground(Color.WHITE);
        squareButton.setToolTipText("Back to Square Screen");
        ...
        //set the square button of the titlePanel to the left side
        titlePanel.add(squareButton, BorderLayout.WEST);
