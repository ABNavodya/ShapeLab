...
public class SemiCirclePanel extends JPanel{
    //Declare semicircle variable
    ...
    public SemiCirclePanel(SemiCircleController semiCircleController){
        this.semiCircleController = semiCircleController;
    }
   ...
   //overridden class from JPanel used to handle the custom drawings on the panel
    ...
    protected void paintComponent(Graphics g) {
        ...
        if (semiCircleController.getShape() != null) {
            ...
            g2.setColor(color);
            g2.fill(semiCircleController.getShape());
        }
    }
}
